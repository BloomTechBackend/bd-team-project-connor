...
public class AddRoundToRoundsActivity {
    private PlayerDao playerDao;
    private RoundsDao roundsDao;
    ...
    public AddRoundToRoundsResult handleRequest(final AddRoundToRoundsRequest addRoundToRoundsRequest, Context context){
        ...
        for (Rounds round1 : rounds) {
            RoundsModel roundsModel = new ModelConverter().toRoundsModel(round1);
